...
for tchunk in range(0,2):
    ...
    all_fit_regrid.attrs['units']='x10^22 J/m^2/mth'
    ...
    run_fit_regrid.attrs['description']='Linear fit slope for 30 year sections of SMURPHS 0-700m and 0-2000m OHC time series'
    run_fit_regrid.attrs['units']='x10^22 J/m^2/mth'
