...
obs_global_file=save_dir+'IAP_OHC_estimate_update300m_700m_2000m.txt'
...
obs_noaa_700=xr.open_dataset(save_dir+'heat_content_anomaly_0-700_yearly.nc',decode_times=False)
...
obs_noaa_2000=xr.open_dataset(save_dir+'heat_content_anomaly_0-2000_pentad.nc',decode_times=False)
...
long_fit_iap.to_netcdf(save_dir+'longfit_obs_iap.nc')
...
all_fit_iap.to_netcdf(save_dir+'allfit_obs_iap.nc')
...
long_fit_noaa.to_netcdf(save_dir+'longfit_obs_noaa.nc')
...
all_fit_noaa.to_netcdf(save_dir+'allfit_obs_noaa.nc')
